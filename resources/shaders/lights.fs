...
vec4 calcPointLight(vec4, vec4, float, PointLight, vec3, vec3);
vec4 calcSpotLight(vec4, vec4, float, SpotLight, vec3, vec3);
vec4 calcDirLight(vec4, vec4, float, DirLight, vec3, vec3);
vec4 calcFog(vec3, vec4, Fog, vec3, DirLight);
float textureProj(vec4, vec2, int);
float calcShadow(vec4, int);
